...
基于区域的损失函数，包含广义Dice损失，敏感特异性损失，IOU LOSS,TVERSKY LOSS, focal tversky loss， asymmetric similarity loss，penalty loss
交叉熵与DIce的联合损失，指数对数损失，
"""
...
class GDiceLoss2(nn.Module):
    def __init__(self, apply_nonlin=None, smooth=1e-5):
        """
        Generalized Dice;用于二维的
        Copy from: https://github.com/LIVIAETS/surface-loss/blob/108bd9892adca476e6cdf424124bc6268707498e/losses.py#L29
        paper: https://arxiv.org/pdf/1707.03237.pdf
        tf code: https://github.com/NifTK/NiftyNet/blob/dev/niftynet/layer/loss_segmentation.py#L279
        """
        super(GDiceLoss2, self).__init__()
...
class SSLoss(nn.Module):
    def __init__(self, apply_nonlin=None, batch_dice=False, do_bg=True, smooth=1.,
                 square=False):
        """
        Sensitivity-Specifity loss敏感性特异性损失
